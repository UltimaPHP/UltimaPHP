...
CREATE TABLE `players_skills` (
  ...
  `blacksmith` float(4,1) NOT NULL DEFAULT '0.0',
  ...
  `detecthidden` float(4,1) NOT NULL DEFAULT '0.0',
  `enticement` float(4,1) NOT NULL DEFAULT '0.0',
  `evalint` float(4,1) NOT NULL DEFAULT '0.0',
  ...
  `lockpick` float(4,1) NOT NULL DEFAULT '0.0',
  `magery` float(4,1) NOT NULL DEFAULT '0.0',
  `magicresist` float(4,1) NOT NULL DEFAULT '0.0',
  ...
  `vet` float(4,1) NOT NULL DEFAULT '0.0',
...
INSERT INTO `players_skills` (`id`, `player`, `alchemy`, `anatomy`, `animallore`, `itemid`, `armslore`, `parrying`, `begging`, `blacksmith`, `bowcraft`, `peacemaking`, `camping`, `carpentry`, `cartography`, `cooking`, `detecthidden`, `enticement`, `evalint`, `healing`, `fishing`, `forensics`, `herding`, `hiding`, `provocation`, `inscription`, `lockpick`, `magery`, `magicresist`, `tactics`, `snooping`, `musicianship`, `poisoning`, `archery`, `spiritspeak`, `stealing`, `tailoring`, `taming`, `tasteid`, `tinkering`, `tracking`, `vet`, `swordsmanship`, `macefighting`, `fencing`, `wrestling`, `lumberjack`, `mining`, `meditation`, `stealth`, `removetrap`, `necromancy`, `focus`, `chivalry`, `bushido`, `ninjitsu`, `spellweaving`, `mysticism`, `imbuing`, `throwing`) VALUES
