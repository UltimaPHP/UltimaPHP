...
class UltimaPHP
{
    ...
    private static function loadIni() {
        ...
        self::$servers[] = array('name' => UltimaPHP::$conf['server']['name'], 'ip' => UltimaPHP::$conf['server']['ip'], 'port' => UltimaPHP::$conf['server']['port'], 'full' => (UltimaPHP::$conf['server']['max_players'] == 0 ? 0 : ceil((UltimaPHP::$clients / UltimaPHP::$conf['server']['max_players']) * 100)), 'timezone' => UltimaPHP::$conf['server']['timezone']);
