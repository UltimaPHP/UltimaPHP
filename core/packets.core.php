...
class Packets {
    ...
    public static function packet_0x07($data, $client) {
        ...
        return UltimaPHP::$socketClients[$client]['account']->player->pickUp($item_serial, $amount);
    }
    ...
    public static function packet_0x34($data, $client) {
        ...
        case 0x04:
            ...
            if ($serial == UltimaPHP::$socketClients[$client]['account']->player->serial) {
                UltimaPHP::$socketClients[$client]['account']->player->statusBarInfo();
            } else {
                ...
                if (method_exists($instance, "statusBarInfo")) {
                    if ($instance->instanceType == UltimaPHP::INSTANCE_PLAYER) {
                        UltimaPHP::$socketClients[$client]['account']->player->statusBarInfo(false, $instance->client);
                    } else {
                        $instance->statusBarInfo($client);
                    }
                }
            }
            break;
     ...
     * Receive client version information from client version 6.0.5.0+
     */
    public static function packet_0xF0($data, $client) {
        if (count($data) < 38) {
            UltimaPHP::$socketClients[$client]['account']->disconnect(4);
            return;
        }
