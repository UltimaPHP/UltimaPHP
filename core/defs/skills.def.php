...
abstract class SkillsDefs {
    ...
    const SKILL_DETECTINGHIDDEN = 14;
    const SKILL_DISCORDANCE     = 15;
    const SKILL_EVALUATINGINTEL = 16;
    ...
    const SKILL_LOCKPICKING     = 24;
    const SKILL_MAGERY          = 25;
    const SKILL_MAGICRESISTANCE = 26;
